...
public class UnitOfWork : IUnitOfWork
{
    ...
    private FallowedUserRepository? _fallowedUserRepository;
    ...
    public ITweetRepository Tweets => _tweetRepository ??= new TweetRepository(_postgresContext);
    public IFallowedUserRepository FallowedUsers => _fallowedUserRepository ??= new FallowedUserRepository(_postgresContext);
