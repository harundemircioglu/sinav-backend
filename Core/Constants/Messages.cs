...
public static class Messages
{
    ...
    public const string SuccessfullyCreatedEntity = "Ekleme işlemi başarıyla tamamlandı";
    public const string SuccessfullyUpdatedEntity = "Güncelleme işlemi başarıyla tamamlandı";
    public const string SuccessfullyDeletedEntity = "Silme işlemi başarıyla tamamlandı";
